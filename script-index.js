document.addEventListener("DOMContentLoaded", function () {
  ...
  class BlocDefinition extends HTMLElement {
    constructor() {
      ...
      const blocId = this.getAttribute("id") || ""; // Récupérer l"ID de l"élément bloc
      let contenu = "";
      ...
      this.innerHTML = `
        <div class="bloc">
          ...
          <div class="bloc-body">
            <div class="bloc-body-content" id="${blocId}">${contenu}</div>
          </div>
        </div>`;
        if (blocId) {
            this.removeAttribute("id"); // Supprimer l"ID de l"élément bloc
          }
    }
  }
